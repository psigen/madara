...
Madara::Expression_Tree::Composite_Equality_Node::prune (bool & can_change)
{
  ...
  {
    ACE_DEBUG ((LM_DEBUG, "\nEXPRESSION COMPILE ERROR: Equality has no left operand\n"));
    return -1;    
  }
  ...
  {
    ACE_DEBUG ((LM_DEBUG, "\nEXPRESSION COMPILE ERROR: Equality has no right operand\n"));
    return -1;    
  }
...
int 
Madara::Expression_Tree::Composite_Equality_Node::evaluate (void)
{
