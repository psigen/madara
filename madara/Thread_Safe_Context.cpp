...
// constructor
Madara::Thread_Safe_Context::Thread_Safe_Context ()
{
}

// destructor
Madara::Thread_Safe_Context::~Thread_Safe_Context (void)
{
}

// return the value of a variable
int
Madara::Thread_Safe_Context::get (const ::std::string & key) const
{
...
bool
Madara::Thread_Safe_Context::exists (const ::std::string & key) const
{
  Context_Guard guard (mutex_);
...
int
Madara::Thread_Safe_Context::inc (const ::std::string & key)
{
  Context_Guard guard (mutex_);
...
int
Madara::Thread_Safe_Context::dec (const ::std::string & key)
{
  Context_Guard guard (mutex_);
...
int
Madara::Thread_Safe_Context::set (const ::std::string & key, long value)
{
  // check for null key
  if (key == "")
    return -1;
...
int
Madara::Thread_Safe_Context::set_if_unequal (const ::std::string & key, 
                                             long value)
{
  // check for null key
  if (key == "")
...
void
Madara::Thread_Safe_Context::print (void) const
{
  Context_Guard guard (mutex_);
...
void
Madara::Thread_Safe_Context::clear (void)
{
  // enter the mutex
  Context_Guard guard (mutex_);
...
void
Madara::Thread_Safe_Context::lock (void)
{
  mutex_.acquire ();
}
...
void
Madara::Thread_Safe_Context::unlock (void)
{
  mutex_.release ();
}