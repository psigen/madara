...
Madara::Knowledge_Base::Knowledge_Base ()
: transport_ (0)
{
...
int
Madara::Knowledge_Base::get (const ::std::string & key) const
{
  return map_.get (key);
}

void
Madara::Knowledge_Base::set (const ::std::string & key, int value)
{
  map_.set (key, value);
}

int
Madara::Knowledge_Base::wait (const ::std::string & expression) const
{
  return 0;
}

void
Madara::Knowledge_Base::add_rule (const ::std::string & expression_copy)
{
...
void
Madara::Knowledge_Base::evaluate (const ::std::string & expression_copy)
{
...
void
Madara::Knowledge_Base::print_rules (void) const
{
...
void
Madara::Knowledge_Base::print_knowledge (void) const
{
...
void
Madara::Knowledge_Base::clear (void)
{
  map_.clear ();
  rules_.clear ();
}
...
void
Madara::Knowledge_Base::test(const long & iterations)
{
  char * keys [] = {
    "bob",
    "bill",
...
void
Madara::Knowledge_Base::clear_rules (void)
{
  rules_.clear ();
}

void
Madara::Knowledge_Base::clear_map (void)
{
  map_.clear ();
}
