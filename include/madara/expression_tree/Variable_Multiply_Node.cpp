...
std::string
Madara::Expression_Tree::Variable_Multiply_Node::expand_key (void) const
{
...
Madara::Knowledge_Record::VALUE_TYPE 
Madara::Expression_Tree::Variable_Multiply_Node::evaluate (void)
{
  return compute ();
}

const std::string &
Madara::Expression_Tree::Variable_Multiply_Node::key () const
{
  return key_;
}
