...
size_t
Madara::Knowledge_Engine::Containers::String_Vector::size (void)
{
  Guard guard (mutex_);
  return vector_.size ();
}
...
std::string
Madara::Knowledge_Engine::Containers::String_Vector::get_name (void)
{
  Guard guard (mutex_);
  return name_;
}
...
Madara::Knowledge_Engine::Containers::String_Vector::operator[] (unsigned int index)
{
  Guard guard (mutex_);
